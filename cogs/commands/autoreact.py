...
class AutoReaction(commands.Cog):
    ...
    async def add(self, ctx, trigger: str, *, emojis: str):
        if len(trigger.split()) > 1:
            embed = discord.Embed(
                title="<:FortuneManager_cross:1227866668152393789> Invalid Trigger",
        ...
        if len(emoji_list) > 10:
            embed = discord.Embed(
                title="<:FortuneManager_cross:1227866668152393789> Too Many Emojis",
        ...
        if len(triggers) >= 10:
            embed = discord.Embed(
                title="<:FortuneManager_notify:1227866804630720565> Trigger Limit Reached",
        ...
        if await self.trigger_exists(ctx.guild.id, trigger):
            embed = discord.Embed(
                title="<:FortuneManager_notify:1227866804630720565> Trigger Exists",
        ...
        embed = discord.Embed(
            title="<:FortuneManager_tick:1227866641027698792> Trigger Added",
    ...
    async def remove(self, ctx, trigger: str):
        if not await self.trigger_exists(ctx.guild.id, trigger):
            embed = discord.Embed(
                title="<:FortuneManager_cross:1227866668152393789> Trigger Not Found",
        ...
        embed = discord.Embed(
            title="<:FortuneManager_tick:1227866641027698792> Trigger Removed",
    ...
    async def reset(self, ctx):
        ...
        if not triggers:
            embed = discord.Embed(
                title="<:FortuneManager_cross:1227866668152393789> No Triggers Set",
        ...
        embed = discord.Embed(
            title="<:FortuneManager_tick:1227866641027698792> All Triggers Reset",
