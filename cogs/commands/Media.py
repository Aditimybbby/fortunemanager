...
class Media(commands.Cog):
    ...
    async def set_db(self):
        async with aiosqlite.connect(legacy_path('media.db')) as db:
            await db.execute('''
            ...
            if not message.attachments:
                ...
                if len(self.infractions[message.author.id]) >= 5:  
                    ...
                    embed = discord.Embed(
                        ...
                        description=(
                            "<a:FortuneManager_WarnFlash:1272569018183843874> You are blacklisted from using my commands due to spamming in the media channel. "
