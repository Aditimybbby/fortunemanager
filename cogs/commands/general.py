...
class General(commands.Cog):
  ...
  async def membercount(self, ctx: commands.Context):
        ...
        embed.add_field(name="__Count Stats:__",
                        value=f"<:FortuneManager_users:1226064812157571163> Total Members: {total_members}\n<:FortuneManager_friend:1228229690376982549> Total Humans: {total_humans}\n<:FortuneManager_bot:1227873668466741320> Total Bots: {total_bots}",
                        inline=False)

        embed.add_field(name="__Presence Stats:__", value=f"<:FortuneManager_online:1228271960233082901> Online: {online}\n<:FortuneManager_dnd:1228272112368750613> Dnd: {dnd}\n<:FortuneManager_idle:1228272291473784852> Idle: {idle}\n<:FortuneManager_offline:1228272024829431873> Offline: {offline}", inline=False)
  ...
  @commands.command(name="users", help="checks total users of FortuneManager.")
  @blacklist_check()
  @ignore_check()
  @commands.cooldown(1, 3, commands.BucketType.user)
  async def users(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      title=f"**<:FortuneManager_users:1226064812157571163> FortuneManager Users**",
  ...
  async def wizz(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      ...
      description=f"**<a:FortuneManager_WarnFlash:1272569018183843874> Successfully Wizzed {ctx.guild.name}**",
      color=self.color,
  ...
  async def invite(self, ctx: commands.Context):
    embed = discord.Embed(title="FortuneManager Invite & Support!",
      description=
      f"> <:created:1272499720153202688> **[FortuneManager - Invite Bot](https://discord.com/oauth2/authorize?client_id=1144179659735572640&permissions=2113268958&scope=bot)**\n> <:created:1272499720153202688> **[FortuneManager - Support](https://discord.gg/fortuneleaf)**",
      color=0x000000)
