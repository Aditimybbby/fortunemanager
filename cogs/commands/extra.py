...
tick = "<:FortuneManager_tick:1227866641027698792>"
cross = "<:FortuneManager_cross:1227866668152393789>"
...
class Extra(commands.Cog):
  ...
  async def uptime(self, ctx):
      ...
      embed = discord.Embed(title=f"FortuneManager Uptime", color=self.color)
      embed.add_field(name="__UTC__", value=f"<:FortuneManager_info:1227625594511163537> {uptime_string}\n\n", inline=False)
      embed.add_field(name="__Online Duration__", value=f"<:FortuneManager_duration:1251052632949395538> {uptime_duration_string}", inline=False)
  ...
  async def serverinfo(self, ctx):
        ...
        embed.add_field(
            name="**__About__**",
            value=f"**Name : ** {ctx.guild.name}\n**ID :** {ctx.guild.id}\n**Owner <:FortuneManager_owner:1228227536207740989> :** {ctx.guild.owner} (<@{ctx.guild.owner_id}>)\n**Created At : ** {c_at}\n**Members :** {len(ctx.guild.members)}",
            inline=False
        )
        ...
        embed.add_field(
            ...
            value=f"Level: {ctx.guild.premium_tier} [<:FortuneManager_booster:1243448375328903199> {ctx.guild.premium_subscription_count} boosts]",
            inline=False
        )
...
**ID:** {member.id}
**Nickname:** {nickk}
**Bot?:** {'<:FortuneManager_tick:1227866641027698792> Yes' if member.bot else '<:FortuneManager_cross:1227866668152393789> No'}
**Badges:** {badges}
...
**Color:** {member.color if member.color else '99aab5'}
  ...
  async def boosts(self, ctx):
    await ctx.send(
      embed=discord.Embed(title=f"<:FortuneManager_booster:1243448375328903199> Boosts Count Of {ctx.guild.name}",
