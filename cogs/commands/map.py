...
class MapView(ui.View):
    ...
    def get_coordinates(self, location):
        ...
        try:
            headers = {'User-Agent': 'FortuneManager Bot (https://olyumpus.vercel.app)'}
    ...
    async def update_embed(self, interaction: discord.Interaction):
        ...
        embed.set_footer(text="Made by FortuneManager Development™")
        try:
    ...
    @discord.ui.button(label="", emoji="<:FortuneManager_arrowLeft:1257731273938571305>", style=ButtonStyle.secondary)
    ...
    @discord.ui.button(label="",  emoji="<:FortuneManager_arrowUp:1257731370814537831>", style=ButtonStyle.secondary)
    ...
    @discord.ui.button(label="", emoji="<:FortuneManager_bin:1254336650075701308>", style=ButtonStyle.danger)
    ...
    @discord.ui.button(label="", emoji="<:FortuneManager_arrowDown:1257731390770909335>", style=ButtonStyle.secondary)
    ...
    @discord.ui.button(label="", emoji="<:FortuneManager_arrowRight:1257731310936391701>", style=ButtonStyle.secondary)
