...
class Welcomer(commands.Cog):
    ...
    async def simple_setup(self, ctx):
        ...
        cancel_button = Button(emoji="<:FortuneManager_bin:1254336650075701308>", style=discord.ButtonStyle.secondary)
    ...
    async def greet_reset(self, ctx):
        ...
        async def yes_button_callback(interaction):
            ...
            embed.title = "<:FortuneManager_tick:1227866641027698792> Success"
