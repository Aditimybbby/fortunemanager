...
async def topgg():
    ...
    webhook = os.getenv("TOPGG_WEBHOOK_URL", "")

    if authorization != os.getenv("TOPGG_WEBHOOK_SECRET", ""):
    ...
    webhook_data = {
        "username": "FortuneManager",
        "content": f"<@{user_id}> voted for <@1144179659735572640>!",
        "embeds": [
            {
                "description": "**[Voted FortuneManager](https://top.gg/bot/1144179659735572640)**\n💖 Thank you for voting for FortuneManager on Top.gg, your support means everything to us!\n",
                "fields": [
                ...
                "footer": {
                    "text": f"Voter ID: {user_id} | FortuneManager Development™ | {footer_time}",
